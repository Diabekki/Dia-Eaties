# Generated by Django 3.2.8 on 2021-10-23 21:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='diaeatiesblog.post')),
            ],
            options={
                'ordering': ['created_on'],
            },
